...
return [
    ...
    */
    ...
    'configs' => [
        ...
        /*
         * FAQ content from Quill (bold, headings, lists, colors, links). No images.
         */
        'notification_faq' => [
            'Core.Encoding' => 'utf-8',
            'HTML.Doctype' => 'HTML 4.01 Transitional',
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,strong,i,em,u,s,strike,del,a[href|title|rel],ul,ol,li[class],p[class|style],br,span[style|class],blockquote,sub,sup',
            'HTML.ForbiddenElements' => '',
            'CSS.AllowedProperties' => 'color,background-color,text-align,padding-left,margin-left',
            'AutoFormat.AutoParagraph' => false,
            'AutoFormat.RemoveEmpty' => false,
        ],
