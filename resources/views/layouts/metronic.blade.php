...
<html class="h-full overflow-x-hidden" data-kt-theme="true" data-kt-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../">
  ...
  <link href="{{ asset('css/famledger-native-select.css') }}" rel="stylesheet"/>
  ...
  <style>
   ...
   /* Metronic sidebar: force KeenIcons inside the menu to follow parent text color */
   #sidebar .kt-menu-icon i.ki-filled,
   #sidebar .kt-menu-icon i.ki-outline,
   #sidebar .kt-menu-icon i[class*="ki-"],
   #sidebar .kt-menu-link i[class*="ki-"],
 ...
 <body class="antialiased flex flex-col min-h-screen w-full max-w-full min-w-0 text-base text-foreground bg-background [--header-height:60px] overflow-x-hidden bg-zinc-950 dark:bg-background!" id="app-body" data-sidebar-collapsed="true">
  ...
  <style>
   ...
   #topbar_user_menu .kt-dropdown-menu { z-index: 9999 !important; }
   #topbar_user_menu.open .kt-dropdown-menu { z-index: 9999 !important; }

   /* User dropdown — pulse frame (aligned with admin/settings pulse UI) */
   .kt-dropdown-menu.famledger-user-dropdown-pulse {
    ...
    box-shadow:
     0 4px 24px rgba(0, 158, 247, 0.15),
     0 16px 40px rgba(15, 23, 42, 0.12) !important;
   }
   .dark .kt-dropdown-menu.famledger-user-dropdown-pulse {
    background: linear-gradient(
     135deg,
     rgba(0, 158, 247, 0.38) 0%,
     rgba(15, 23, 42, 0.92) 48%,
     rgba(14, 165, 233, 0.28) 100%
    ) !important;
    box-shadow:
     0 4px 28px rgba(0, 158, 247, 0.14),
     0 20px 48px rgba(0, 0, 0, 0.4) !important;
   }
   .famledger-user-dropdown-pulse-inner {
    display: flex;
   ...
   .dark .famledger-user-dropdown-pulse-inner {
    background: rgb(15 23 42 / 0.98);
    box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.06);
   }
   .famledger-user-dropdown-pulse-inner > div:first-of-type {
    border-bottom: 1px solid rgba(14, 165, 233, 0.14) !important;
    background: linear-gradient(180deg, rgba(240, 249, 255, 0.55) 0%, rgba(248, 252, 255, 0.12) 100%);
   }
   .dark .famledger-user-dropdown-pulse-inner > div:first-of-type {
   ...
   .famledger-user-dropdown-pulse-inner > div:first-of-type .font-semibold {
    color: #009ef7 !important;
    font-weight: 700;
    letter-spacing: -0.02em;
   }
   .dark .famledger-user-dropdown-pulse-inner > div:first-of-type .font-semibold {
    color: #38bdf8 !important;
   }
   .famledger-user-dropdown-pulse-inner > ul + div {
    border-top: 1px solid rgba(14, 165, 233, 0.12);
    margin-top: 0.125rem;
   }
   .dark .famledger-user-dropdown-pulse-inner > ul + div {
    border-top-color: rgba(14, 165, 233, 0.18);
   }

   /* User dropdown — pulse menu rows (links, separators, footer button) */
   .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-sub {
    padding-inline: 0.35rem;
    padding-block: 0.35rem;
   }
   .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-link {
   ...
   @media (hover: hover) {
    .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-link:hover {
     background: rgba(0, 158, 247, 0.08) !important;
     border-color: rgba(0, 158, 247, 0.22) !important;
     color: #0369a1 !important;
     box-shadow: 0 0 0 1px rgba(0, 158, 247, 0.06);
    }
   }
   .dark .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-link:hover {
    background: rgba(14, 165, 233, 0.12) !important;
    border-color: rgba(14, 165, 233, 0.3) !important;
    color: #bae6fd !important;
    box-shadow: none;
   }
   .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-link i {
    color: #009ef7 !important;
   }
   .dark .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-link i {
    color: #38bdf8 !important;
   }
   @media (hover: hover) {
    .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-link:hover i {
     color: #0284c7 !important;
    }
   }
   .dark .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-link:hover i {
    color: #7dd3fc !important;
   }
   .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-link.text-destructive i {
    color: #ef4444 !important;
   }
   .dark .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-link.text-destructive i {
    color: #f87171 !important;
   }
   @media (hover: hover) {
    .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-link.text-destructive:hover {
   ...
   .dark .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-link.text-destructive:hover {
    background: rgba(248, 113, 113, 0.12) !important;
    border-color: rgba(248, 113, 113, 0.35) !important;
    color: #fecaca !important;
   }
   .dark .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-link.text-destructive:hover i {
    color: #fecaca !important;
   }
   .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-separator {
    margin-inline: 0.65rem !important;
    margin-block: 0.5rem !important;
    background: linear-gradient(90deg, transparent 0%, rgba(14, 165, 233, 0.28) 50%, transparent 100%) !important;
    opacity: 1;
   }
   .dark .famledger-user-dropdown-pulse-inner .kt-dropdown-menu-separator {
    background: linear-gradient(90deg, transparent 0%, rgba(56, 189, 248, 0.35) 50%, transparent 100%) !important;
   }
   .famledger-user-dropdown-pulse-inner .kt-btn.kt-btn-outline {
   ...
   @media (hover: hover) {
    .famledger-user-dropdown-pulse-inner .kt-btn.kt-btn-outline:hover {
     border-color: #009ef7 !important;
     background: rgba(0, 158, 247, 0.08) !important;
     color: #009ef7 !important;
     box-shadow: 0 2px 10px rgba(0, 158, 247, 0.2);
    }
   }
   .dark .famledger-user-dropdown-pulse-inner .kt-btn.kt-btn-outline:hover {
   ...
   /* PulseProfile Lottie avatar sizing (used in topbar dropdown trigger). */
   #lottie-profile-avatar {
    display: block;
    position: absolute;
    inset: 0;
    width: 100%;
   ...
   */
   ...
   .kt-container-fixed .grid > a.kt-card {
     margin: 0.5rem !important;
     box-sizing: border-box !important;
   }
   .kt-container-fixed .families-grid > div {
     margin: 0.5rem !important;
     box-sizing: border-box !important;
   }
   .kt-container-fixed .grid,
   .kt-container-fixed .families-grid {
   ...
   /* Card load animation (main content only) */
   @keyframes card-load-in {
     from { opacity: 0; transform: translateY(12px); }
     to { opacity: 1; transform: translateY(0); }
   }
   .kt-container-fixed .kt-card,
   .kt-container-fixed .card,
   .kt-container-fixed .families-grid > div {
     animation: card-load-in 0.4s ease-out forwards;
     transition: transform 0.25s ease, box-shadow 0.25s ease, border-color 0.2s ease;
   }
   /* Stagger load for cards in grids */
   .kt-container-fixed .grid > .kt-card:nth-child(1), .kt-container-fixed .grid > a.kt-card:nth-child(1) { animation-delay: 0.02s; }
   .kt-container-fixed .grid > .kt-card:nth-child(2), .kt-container-fixed .grid > a.kt-card:nth-child(2) { animation-delay: 0.06s; }
   .kt-container-fixed .grid > .kt-card:nth-child(3), .kt-container-fixed .grid > a.kt-card:nth-child(3) { animation-delay: 0.1s; }
   .kt-container-fixed .grid > .kt-card:nth-child(4), .kt-container-fixed .grid > a.kt-card:nth-child(4) { animation-delay: 0.14s; }
   .kt-container-fixed .grid > .kt-card:nth-child(5), .kt-container-fixed .grid > a.kt-card:nth-child(5) { animation-delay: 0.18s; }
   .kt-container-fixed .grid > .kt-card:nth-child(6), .kt-container-fixed .grid > a.kt-card:nth-child(6) { animation-delay: 0.22s; }
   .kt-container-fixed .families-grid > div:nth-child(1) { animation-delay: 0.02s; }
   .kt-container-fixed .families-grid > div:nth-child(2) { animation-delay: 0.06s; }
   .kt-container-fixed .families-grid > div:nth-child(3) { animation-delay: 0.1s; }
   .kt-container-fixed .families-grid > div:nth-child(4) { animation-delay: 0.14s; }
   .kt-container-fixed .families-grid > div:nth-child(5) { animation-delay: 0.18s; }
   .kt-container-fixed .families-grid > div:nth-child(6) { animation-delay: 0.22s; }
   .kt-container-fixed .dashboard-kpi-grid .dashboard-kpi-card:nth-child(1) { animation-delay: 0.02s; }
   .kt-container-fixed .dashboard-kpi-grid .dashboard-kpi-card:nth-child(2) { animation-delay: 0.06s; }
   .kt-container-fixed .dashboard-kpi-grid .dashboard-kpi-card:nth-child(3) { animation-delay: 0.1s; }
   .kt-container-fixed .dashboard-kpi-grid .dashboard-kpi-card:nth-child(4) { animation-delay: 0.14s; }
   .kt-container-fixed .project-kpi-grid .project-kpi-card:nth-child(1) { animation-delay: 0.02s; }
   .kt-container-fixed .project-kpi-grid .project-kpi-card:nth-child(2) { animation-delay: 0.06s; }
   .kt-container-fixed .project-kpi-grid .project-kpi-card:nth-child(3) { animation-delay: 0.1s; }
   .kt-container-fixed .project-kpi-grid .project-kpi-card:nth-child(4) { animation-delay: 0.14s; }
   /* Report KPI grid (standard for all report pages — cash-flow style) */
   .kt-container-fixed .report-kpi-grid,
   .kt-container-fixed .cash-flow-kpi-grid {
   ...
   .kt-container-fixed .report-kpi-grid .report-kpi-card,
   .kt-container-fixed .report-kpi-grid .cash-flow-kpi-card,
   .kt-container-fixed .cash-flow-kpi-grid .report-kpi-card,
   .kt-container-fixed .cash-flow-kpi-grid .cash-flow-kpi-card {
     min-width: 0 !important;
     max-width: none !important;
     box-sizing: border-box !important;
     padding-top: 1.5rem !important;
   }
   .kt-container-fixed .report-kpi-grid.report-kpi-grid--2 { grid-template-columns: repeat(2, 1fr) !important; }
   @media (max-width: 767px) {
     .kt-container-fixed .report-kpi-grid,
     .kt-container-fixed .cash-flow-kpi-grid { grid-template-columns: 1fr !important; }
   }
   .kt-container-fixed .report-kpi-grid .report-kpi-card:nth-child(1),
   .kt-container-fixed .report-kpi-grid .cash-flow-kpi-card:nth-child(1),
   .kt-container-fixed .cash-flow-kpi-grid .report-kpi-card:nth-child(1),
   .kt-container-fixed .cash-flow-kpi-grid .cash-flow-kpi-card:nth-child(1) { animation-delay: 0.02s; }
   .kt-container-fixed .report-kpi-grid .report-kpi-card:nth-child(2),
   .kt-container-fixed .cash-flow-kpi-grid .cash-flow-kpi-card:nth-child(2) { animation-delay: 0.06s; }
   .kt-container-fixed .report-kpi-grid .report-kpi-card:nth-child(3),
   .kt-container-fixed .cash-flow-kpi-grid .cash-flow-kpi-card:nth-child(3) { animation-delay: 0.1s; }
   .kt-container-fixed .report-kpi-grid .report-kpi-card:nth-child(4),
   .kt-container-fixed .cash-flow-kpi-grid .cash-flow-kpi-card:nth-child(4) { animation-delay: 0.14s; }
   /* Card hover (smooth lift + shadow) */
   .kt-container-fixed .kt-card:hover,
   .kt-container-fixed .card:hover,
   .kt-container-fixed .families-grid > div:hover {
     transform: translateY(-3px);
     box-shadow: 0 12px 28px -8px rgb(0 0 0 / 0.12), 0 6px 12px -6px rgb(0 0 0 / 0.06);
   }
    ...
    <div class="kt-container-fixed flex items-center justify-between flex-wrap gap-3 w-full">
     ...
     <div class="flex items-center gap-2">
      ...
      <div data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-trigger="click">
       ...
       <div class="kt-dropdown-menu w-[220px] famledger-user-dropdown-pulse" data-kt-dropdown-menu="true">
        <div class="famledger-user-dropdown-pulse-inner">
         <div class="px-2.5 py-1.5 border-b border-border">
          <span class="text-sm font-semibold text-foreground block">{{ auth()->user()->name }}</span>
          <span class="text-xs text-muted-foreground block">{{ auth()->user()->email }}</span>
         </div>
         <ul class="kt-dropdown-menu-sub py-1">
          <li>
           <a class="kt-dropdown-menu-link" href="{{ route('profile.edit') }}">
            <i class="ki-filled ki-profile-circle"></i> {{ __('My Profile') }}
           </a>
          </li>
          <li>
      ...
      @else
      <a class="kt-btn kt-btn-sm kt-btn-ghost text-white" href="{{ route('login') }}">Log in</a>
      @endauth
       ...
       <div class="kt-menu flex flex-col w-full gap-1.5 px-3.5 hidden" data-kt-menu="true" data-kt-menu-accordion-expand-all="false" id="sidebar_primary_menu">
         <div class="kt-menu-item">
          <a class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-item-active:bg-accent/60 kt-menu-link-hover:bg-accent/60 !menu-item-here:bg-transparent" href="{{ route('dashboard') }}">
           <span class="kt-menu-icon items-start text-lg text-secondary-foreground kt-menu-item-active:text-foreground kt-menu-item-here:text-foreground">
            <i class="ki-filled ki-home-3">
            </i>
           </span>
          <span class="kt-menu-title text-sm text-foreground font-medium kt-menu-item-here:text-foreground kt-menu-item-active:text-foreground kt-menu-link-hover:text-foreground">
           Dashboard
           </span>
          </a>
         </div>
          ...
          {{-- Family Section --}}
          <div class="kt-menu-item {{ request()->routeIs('families.*') ? 'kt-menu-item-show' : '' }}" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
           <div class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-item-hover:bg-transparent kt-menu-item-here:bg-transparent">
            <span class="kt-menu-icon items-start text-muted-foreground text-lg kt-menu-item-here:text-foreground kt-menu-item-show:text-foreground kt-menu-link-hover:text-foreground">
             <i class="ki-filled ki-profile-circle"></i>
            </span>
            <span class="kt-menu-title font-medium text-sm text-secondary-foreground kt-menu-item-here:text-foreground kt-menu-item-show:text-foreground kt-menu-link-hover:text-foreground">Family</span>
           ...
           <div class="kt-menu-accordion gap-px ps-7">
            <div class="kt-menu-item {{ request()->routeIs('families.overview', 'families.show') ? 'kt-menu-item-active' : '' }}">
            ...
            <div class="kt-menu-item {{ request()->routeIs('families.wallets.*') ? 'kt-menu-item-active' : '' }}">
             <a class="kt-menu-link py-2 px-2.5 rounded-md kt-menu-item-active:bg-secondary kt-menu-link-hover:bg-secondary" href="{{ route('families.wallets.index') }}">
              <span class="kt-menu-icon text-base"><i class="ki-filled ki-wallet"></i></span>
              <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium">Wallets</span>
             </a>
            </div>
            <div class="kt-menu-item {{ request()->routeIs('families.transactions.*') ? 'kt-menu-item-active' : '' }}">
             <a class="kt-menu-link py-2 px-2.5 rounded-md kt-menu-item-active:bg-secondary kt-menu-link-hover:bg-secondary" href="{{ route('families.transactions.index') }}">
              <span class="kt-menu-icon text-base"><i class="ki-filled ki-arrows-loop"></i></span>
              <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium">Transactions</span>
             </a>
            </div>
            <div class="kt-menu-item {{ request()->routeIs('families.budgets.*') ? 'kt-menu-item-active' : '' }}">
             <a class="kt-menu-link py-2 px-2.5 rounded-md kt-menu-item-active:bg-secondary kt-menu-link-hover:bg-secondary" href="{{ route('families.budgets.index') }}">
              <span class="kt-menu-icon text-base"><i class="ki-filled ki-chart-line-up"></i></span>
              <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium">Budgets</span>
             </a>
            </div>
            <div class="kt-menu-item {{ request()->routeIs('families.reports.*') ? 'kt-menu-item-active' : '' }}">
             <a class="kt-menu-link py-2 px-2.5 rounded-md kt-menu-item-active:bg-secondary kt-menu-link-hover:bg-secondary" href="{{ route('families.reports.index') }}">
              <span class="kt-menu-icon text-base"><i class="ki-filled ki-chart-pie-simple"></i></span>
              <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium">Reports</span>
             </a>
            </div>
           </div>
          </div>
         ...
         <div class="kt-menu-item" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
          <div class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-item-hover:bg-transparent kt-menu-item-here:bg-transparent">
           ...
           <span class="kt-menu-title font-medium text-sm text-secondary-foreground kt-menu-item-here:text-foreground kt-menu-item-show:text-foreground kt-menu-link-hover:text-foreground">
            Settings &amp; Account
           </span>
           <span class="kt-menu-arrow text-muted-foreground kt-menu-item-here:text-muted-foreground kt-menu-item-show:text-foreground kt-menu-link-hover:text-foreground">
          ...
          <div class="kt-menu-accordion gap-px ps-7">
           <div class="kt-menu-item" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
            <div class="kt-menu-link py-2 px-2.5 rounded-md border border-transparent !menu-item-here:bg-transparent">
             <span class="kt-menu-title text-sm text-foreground kt-menu-item-here:text-foreground kt-menu-item-show:text-foreground kt-menu-link-hover:text-foreground">
              Account Home
             </span>
             <span class="kt-menu-arrow text-muted-foreground kt-menu-item-here:text-muted-foreground kt-menu-item-show:text-foreground kt-menu-link-hover:text-foreground">
              <span class="inline-flex kt-menu-item-show:hidden">
            ...
            <div class="kt-menu-accordion gap-px ps-2.5">
             <div class="kt-menu-item">
              <a class="kt-menu-link py-2 px-2.5 rounded-md kt-menu-item-active:bg-secondary kt-menu-link-hover:bg-secondary" href="#">
               <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-foreground kt-menu-link-hover:text-foreground">
                Light Sidebar
               </span>
              </a>
             </div>
        ...
        <div class="kt-menu flex flex-col w-full gap-1.5 px-3.5" data-kt-menu="true" data-kt-menu-accordion-expand-all="false" id="sidebar_famledger_menu">
         ...
         <div class="kt-menu-item {{ request()->routeIs('dashboard') || request()->routeIs('admin.dashboard') ? 'kt-menu-item-active' : '' }}" data-fl-nav="dashboard">
          ...
          <a href="{{ route('admin.dashboard') }}" class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-item-active:bg-accent/60 kt-menu-link-hover:bg-accent/60 {{ request()->routeIs('admin.dashboard') ? 'bg-accent/60 fl-sidebar-route-active' : '' }}">
           ...
           <span class="kt-menu-title text-sm font-medium kt-menu-item-active:text-foreground {{ request()->routeIs('admin.dashboard') ? 'text-foreground' : 'text-foreground kt-menu-link-hover:text-foreground' }}">
            Dashboard
           </span>
          </a>
          @else
          <a href="{{ route('dashboard') }}" class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-item-active:bg-accent/60 kt-menu-link-hover:bg-accent/60 {{ request()->routeIs('dashboard') ? 'bg-accent/60 fl-sidebar-route-active' : '' }}">
           ...
           <span class="kt-menu-title text-sm font-medium kt-menu-item-active:text-foreground {{ request()->routeIs('dashboard') ? 'text-foreground' : 'text-foreground kt-menu-link-hover:text-foreground' }}">
            Dashboard
           </span>
          </a>
          @endcan
        ...
        @if(isset($currentFamily) && $currentFamily)
         <div class="kt-menu-item {{ $flAccountsAccordionOpen ? 'show here' : '' }}" data-fl-nav="accounts" @if($flAccountsAccordionOpen) data-fl-persist-open="1" @endif data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
          <div class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md border border-transparent">
           ...
           <span class="kt-menu-title text-sm text-foreground font-medium">Accounts</span>
           <span class="kt-menu-arrow text-muted-foreground">
            <span class="inline-flex kt-menu-item-show:hidden"><i class="ki-filled ki-down text-xs"></i></span>
            <span class="hidden kt-menu-item-show:inline-flex"><i class="ki-filled ki-up text-xs"></i></span>
           </span>
        ...
        @endcan
         ...
         <div class="kt-menu-item {{ $flReportsAccordionOpen ? 'show here' : '' }}" data-fl-nav="reports" @if($flReportsAccordionOpen) data-fl-persist-open="1" @endif data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
          ...
          <div class="kt-menu-accordion gap-px ps-2.5">
           {{-- Wealth overview --}}
           <div class="kt-menu-item">
            <a href="{{ route('families.wealth.index') }}"
               class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-link-hover:bg-secondary {{ request()->routeIs('families.wealth.index') ? 'bg-secondary' : '' }}">
             <span class="kt-menu-icon items-start text-lg text-muted-foreground shrink-0">
              <i class="ki-filled ki-dollar text-lg"></i>
             </span>
             <span class="kt-menu-title text-sm text-secondary-foreground kt-menu-link-hover:text-foreground">Wealth</span>
            </a>
           </div>

           {{-- General / Family report --}}
           <div class="kt-menu-item">
            <a href="{{ route('families.reports.index') }}"
               class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-link-hover:bg-secondary {{ request()->routeIs('families.reports.index') ? 'bg-secondary' : '' }}">
             <span class="kt-menu-icon items-start text-lg text-muted-foreground shrink-0">
           ...
           {{-- Finance reports (cash flow tab set) --}}
           <div class="kt-menu-item">
            <a href="{{ route('families.reports.cash-flow') }}"
               class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-link-hover:bg-secondary {{ request()->routeIs('families.reports.cash-flow') ? 'bg-secondary' : '' }}">
             <span class="kt-menu-icon items-start text-lg text-muted-foreground shrink-0">
           ...
           {{-- Projects report --}}
           <div class="kt-menu-item">
            <a href="{{ route('families.reports.project-summary') }}"
               class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-link-hover:bg-secondary {{ request()->routeIs('families.reports.project-summary') ? 'bg-secondary' : '' }}">
             <span class="kt-menu-icon items-start text-lg text-muted-foreground shrink-0">
           ...
           {{-- Budgets report --}}
           <div class="kt-menu-item">
            <a href="{{ route('families.reports.budget-vs-actual') }}"
               class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-link-hover:bg-secondary {{ request()->routeIs('families.reports.budget-vs-actual') ? 'bg-secondary' : '' }}">
             <span class="kt-menu-icon items-start text-lg text-muted-foreground shrink-0">
              <i class="ki-filled ki-chart-pie-simple text-lg"></i>
             </span>
             <span class="kt-menu-title text-sm text-secondary-foreground kt-menu-link-hover:text-foreground">Budget</span>
            </a>
           </div>

           {{-- Property reports --}}
           <div class="kt-menu-item">
            <a href="{{ route('families.reports.property') }}"
               class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-link-hover:bg-secondary {{ request()->routeIs('families.reports.property') ? 'bg-secondary' : '' }}">
             <span class="kt-menu-icon items-start text-lg text-muted-foreground shrink-0">
         ...
         <div class="kt-menu-item {{ $flPropertyAccordionOpen ? 'show here' : '' }}" data-fl-nav="property" @if($flPropertyAccordionOpen) data-fl-persist-open="1" @endif data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
          ...
          <div class="kt-menu-accordion gap-px ps-2.5">
           <div class="kt-menu-item">
            <a href="{{ route('families.properties.assets') }}" class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-link-hover:bg-secondary {{ request()->routeIs('families.properties.assets') ? 'bg-secondary' : '' }}">
           ...
           <div class="kt-menu-item">
            <a href="{{ route('families.properties.create') }}" class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-link-hover:bg-secondary {{ request()->routeIs('families.properties.create') ? 'bg-secondary' : '' }}">
           ...
           <div class="kt-menu-item">
            <a href="{{ route('families.properties.maintenance') }}" class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-link-hover:bg-secondary {{ request()->routeIs('families.properties.maintenance') ? 'bg-secondary' : '' }}">
           ...
           <div class="kt-menu-item">
            <a href="{{ route('families.properties.valuations') }}" class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-link-hover:bg-secondary {{ request()->routeIs('families.properties.valuations') ? 'bg-secondary' : '' }}">
           ...
           <div class="kt-menu-item">
            <a href="{{ route('families.properties.documents') }}" class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-link-hover:bg-secondary {{ request()->routeIs('families.properties.documents') ? 'bg-secondary' : '' }}">
           ...
           <div class="kt-menu-item">
            <a href="{{ route('families.properties.depreciation') }}" class="kt-menu-link gap-2.5 py-2 px-2.5 rounded-md kt-menu-link-hover:bg-secondary {{ request()->routeIs('families.properties.depreciation') ? 'bg-secondary' : '' }}">
       ...
       <div class="hidden">
        ...
        <div class="kt-menu flex flex-col w-full gap-1.5 px-3.5" data-kt-menu="true" data-kt-menu-accordion-expand-all="true" id="sidebar_secondary_menu">
         <div class="kt-menu-item">
          <a class="kt-menu-link py-1 px-2.5" href="#">
           <span class="rounded-md flex items-center justify-center size-7 bg-coal-black kt-menu-link-hover:border-none me-2">
            <img alt="" class="size-3.5" src="{{ asset('metronic/assets/media/brand-logos/x-dark.svg') }}"/>
           </span>
         ...
         <div class="kt-menu-item">
          <a class="kt-menu-link py-1 px-2.5" href="#">
           <span class="rounded-md flex items-center justify-center size-7 bg-coal-black kt-menu-link-hover:border-none me-2">
            <img alt="" class="size-3.5" src="{{ asset('metronic/assets/media/brand-logos/slack.svg') }}"/>
           </span>
           <span class="kt-menu-title text-sm text-secondary-foreground kt-menu-item-here:text-mono kt-menu-item-active:text-mono kt-menu-link-hover:text-mono">
            @keenthemes_hub
           </span>
         ...
         <div class="kt-menu-item">
          <a class="kt-menu-link py-1 px-2.5" href="#">
           <span class="rounded-md flex items-center justify-center size-7 bg-coal-black kt-menu-link-hover:border-none me-2">
            <img alt="" class="size-3.5" src="{{ asset('metronic/assets/media/brand-logos/figma.svg') }}"/>
           </span>
           <span class="kt-menu-title text-sm text-secondary-foreground kt-menu-item-here:text-mono kt-menu-item-active:text-mono kt-menu-link-hover:text-mono">
            metronic
           </span>
    ...
    <!-- Footer -->
     <div class="flex flex-center justify-between shrink-0 ps-4 pe-3.5 mb-3.5" id="sidebar_footer">
      ...
      <div data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-offset-rtl="-20px, 10px" data-kt-dropdown-placement="bottom-start" data-kt-dropdown-placement-rtl="bottom-end" data-kt-dropdown-trigger="click">
       ...
       <div class="kt-dropdown-menu w-[250px] famledger-user-dropdown-pulse" data-kt-dropdown-menu="true">
        <div class="famledger-user-dropdown-pulse-inner">
       ...
       <div class="hidden kt-drawer kt-drawer-end card flex-col max-w-[90%] w-[450px] top-5 bottom-5 end-5 rounded-xl border border-border" data-kt-drawer="true" data-kt-drawer-container="body" id="notifications_drawer">
          ...
          <div class="kt-menu-item {{ request()->routeIs('families.*') ? 'kt-menu-item-show' : '' }}" data-kt-menu-item-toggle="accordion" data-kt-menu-item-trigger="click">
           ...
           <div class="kt-menu-accordion gap-px ps-7">
            ...
            <div class="kt-menu-item {{ request()->routeIs('families.wallets.*') ? 'kt-menu-item-active' : '' }}">
             <a class="kt-menu-link py-2 px-2.5 rounded-md kt-menu-item-active:bg-secondary kt-menu-link-hover:bg-secondary" href="{{ route('families.wallets.index') }}">
              <span class="kt-menu-icon text-base"><i class="ki-filled ki-wallet"></i></span>
              <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-foreground kt-menu-link-hover:text-foreground">Wallets</span>
             </a>
            </div>
            {{-- Transactions --}}
            <div class="kt-menu-item {{ request()->routeIs('families.transactions.*') ? 'kt-menu-item-active' : '' }}">
             <a class="kt-menu-link py-2 px-2.5 rounded-md kt-menu-item-active:bg-secondary kt-menu-link-hover:bg-secondary" href="{{ route('families.transactions.index') }}">
              <span class="kt-menu-icon text-base"><i class="ki-filled ki-arrows-loop"></i></span>
              <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-foreground kt-menu-link-hover:text-foreground">Transactions</span>
             </a>
            </div>
            {{-- Budgets --}}
            <div class="kt-menu-item {{ request()->routeIs('families.budgets.*') ? 'kt-menu-item-active' : '' }}">
             <a class="kt-menu-link py-2 px-2.5 rounded-md kt-menu-item-active:bg-secondary kt-menu-link-hover:bg-secondary" href="{{ route('families.budgets.index') }}">
              <span class="kt-menu-icon text-base"><i class="ki-filled ki-chart-line-up"></i></span>
              <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-foreground kt-menu-link-hover:text-foreground">Budgets</span>
             </a>
            </div>
            {{-- Reports --}}
            <div class="kt-menu-item {{ request()->routeIs('families.reports.*') ? 'kt-menu-item-active' : '' }}">
             <a class="kt-menu-link py-2 px-2.5 rounded-md kt-menu-item-active:bg-secondary kt-menu-link-hover:bg-secondary" href="{{ route('families.reports.index') }}">
              <span class="kt-menu-icon text-base"><i class="ki-filled ki-chart-pie-simple"></i></span>
              <span class="kt-menu-title text-sm text-foreground kt-menu-item-active:font-medium kt-menu-item-active:text-foreground kt-menu-link-hover:text-foreground">Reports</span>
             </a>
            </div>
           </div>
          </div>
         ...
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="grow flex flex-col gap-5 pt-3 pb-4 divider-y divider-border">
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-4.png') }}">
              </img>
             </div>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-5.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5" id="notification_request_3">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-27.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-10.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
            ...
            <div class="flex flex-col gap-3.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <img class="h-5" src="{{ asset('metronic/assets/media/file-types/pdf.svg') }}"/>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-11.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-14.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-offline size-2.5">
            ...
            <div class="flex flex-col gap-3.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center justify-center w-[26px] h-[30px] shrink-0 bg-background rounded-sm border border-border">
               <img class="h-5" src="{{ asset('metronic/assets/media/file-types/figma.svg') }}"/>
              </div>
              <a class="hover:text-primary font-medium text-secondary-foreground text-xs me-1" href="#">
               Launcher-UIkit.fig
              </a>
         ...
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="flex flex-col gap-5 pt-3 pb-4">
           <div class="flex grow gap-2.5 px-5" id="notification_request_13">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-25.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-34.png') }}"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
            ...
            <div class="flex flex-col gap-3.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center gap-1.5">
               <img class="h-6" src="{{ asset('metronic/assets/media/file-types/xls.svg') }}"/>
           ...
           <div class="flex grow gap-2 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-29.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
             ...
             <div class="kt-card shadow-none p-3.5 gap-3.5 rounded-lg bg-muted/70">
              <div class="flex items-center justify-between flex-wrap gap-2.5">
               ...
               <div class="flex -space-x-2">
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-3.png') }}"/>
                </div>
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-2.png') }}"/>
                </div>
               </div>
              </div>
           ...
           <div class="flex grow gap-2.5 px-5" id="notification_request_3">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-30.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-24.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
         ...
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="flex flex-col gap-5 pt-3 pb-4">
           <div class="flex grow gap-2 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-15.png') }}"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
            ...
            <div class="flex flex-col gap-3 grow" id="notification_request_10">
             ...
             <div class="kt-card shadow-none p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center justify-between flex-wrap gap-2.5">
               ...
               <div class="flex -space-x-2">
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-4.png') }}"/>
                </div>
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-1.png') }}"/>
                </div>
                <div class="flex">
                 <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-2.png') }}"/>
                </div>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-6.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-12.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
            ...
            <div class="flex flex-col gap-3.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center gap-1.5">
               <img class="h-6" src="{{ asset('metronic/assets/media/file-types/word.svg') }}"/>
               <div class="flex flex-col gap-0.5">
                <a class="hover:text-primary font-medium text-secondary-foreground text-xs" href="#">
                 Landing-page.docx
                </a>
             ...
             <div class="kt-card shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center gap-1.5">
               <img class="h-6" src="{{ asset('metronic/assets/media/file-types/svg.svg') }}"/>
               <div class="flex flex-col gap-0.5">
                <a class="hover:text-primary font-medium text-secondary-foreground text-xs" href="#">
                 New-icon.svg
                </a>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-21.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
		...
		design is simply stunning! From layout to color, it's a work of art!
           ...
           <div class="flex grow gap-2.5 px-5" id="notification_request_3">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-13.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
         ...
         <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true" data-kt-scrollable-dependencies="#header" data-kt-scrollable-max-height="auto" data-kt-scrollable-offset="150px">
          <div class="flex flex-col gap-5 pt-3 pb-4">
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-1.png') }}">
              </img>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
            ...
            <div class="flex flex-col gap-2.5 grow">
             ...
             <div class="flex items-center gap-2.5">
              <div class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
               <div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24" style="background-image: url('{{ asset('metronic/assets/media/images/600x600/6.jpg') }}')">
               </div>
              ...
              <div class="kt-card shadow-none flex flex-col gap-3.5 bg-muted/70 w-40">
               <div class="bg-cover bg-no-repeat kt-card-rounded-t shrink-0 h-24" style="background-image: url('{{ asset('metronic/assets/media/images/600x600/1.jpg') }}')">
               </div>
               <div class="px-2.5 pb-2">
                <a class="font-medium block text-secondary-foreground hover:text-primary text-xs leading-4 mb-0.5" href="#">
           ...
           <div class="flex grow gap-2.5 px-5" id="notification_request_17">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-19.png') }}"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
            ...
            <div class="flex flex-col gap-2.5 grow">
             ...
             <div class="kt-card shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
              <div class="flex items-center justify-center w-[26px] h-[30px] shrink-0 bg-white rounded-sm border border-border">
               <img class="h-5" src="{{ asset('metronic/assets/media/brand-logos/jira.svg') }}"/>
              </div>
              <a class="hover:text-primary font-medium text-secondary-foreground text-xs me-1" href="#">
               User-feedback.jira
              </a>
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-17.png') }}"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
		...
		article
           ...
           <div class="flex grow gap-2.5 px-5">
            <div class="kt-avatar size-8">
             <div class="kt-avatar-image">
              <img alt="avatar" src="{{ asset('metronic/assets/media/avatars/300-9.png') }}"/>
             </div>
             <div class="kt-avatar-indicator -end-2 -bottom-2">
              <div class="kt-avatar-status kt-avatar-status-online size-2.5">
              </div>
    ...
    <div id="famledger_main_column" class="flex flex-col grow min-h-0 min-w-0 basis-0 w-full max-w-full overflow-hidden lg:rounded-l-xl bg-background border border-input lg:ms-(--sidebar-width)">
     ...
     <div class="flex items-center justify-between shrink-0 px-4 lg:px-6 h-14 border-b border-border bg-background sticky top-0 z-50">
      <div class="flex items-center gap-3 min-w-0">
       <button type="button" class="kt-btn kt-btn-icon kt-btn-ghost shrink-0 hidden lg:flex" id="sidebar_toggle" title="Shrink sidebar" aria-label="Shrink sidebar">
        <i class="ki-filled ki-double-left text-xl sidebar-expand-icon"></i>
        <i class="ki-filled ki-double-right text-xl sidebar-collapse-icon hidden"></i>
       </button>
       <h1 class="text-lg font-semibold text-foreground truncate">
        ...
        @else
         @php
          ...
          $label = $name ? \Illuminate\Support\Str::title(str_replace(['.', '-', '_'], ' ', $name)) : 'Dashboard';
         @endphp
         {{ $label }}
        @endif
       </h1>
      ...
      <div class="flex items-center gap-2 shrink-0">
       ...
       <div class="relative z-50 ml-auto" data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px" data-kt-dropdown-placement="bottom-end" data-kt-dropdown-trigger="click" id="topbar_user_menu">
        <div class="cursor-pointer shrink-0 flex items-center gap-2.5 py-1.5 pl-2.5 pr-1 rounded-lg hover:bg-accent/60" data-kt-dropdown-toggle="true">
         ...
         <div class="relative w-9 h-9 rounded-full border-2 border-border shrink-0 order-last overflow-hidden">
          <img
           alt="{{ auth()->user()->name }}"
         ...
         <div class="famledger-user-dropdown-pulse-inner">
          <div class="flex items-center gap-3 px-2.5 py-2 border-b border-border">
           ...
           <div class="min-w-0">
            ...
            <span class="text-xs text-muted-foreground block truncate">{{ auth()->user()->email }}</span>
           </div>
          </div>
          <ul class="kt-dropdown-menu-sub py-1">
           <li>
       ...
       @else
       <a class="kt-btn kt-btn-sm kt-btn-outline" href="{{ route('login') }}">Log in</a>
       @endauth
      </div>
     </div>
     <div class="flex flex-col flex-1 basis-0 min-h-0 overflow-y-auto overscroll-y-contain lg:[--kt-scrollbar-width:auto] pt-5 min-w-0 w-full max-w-full" id="scrollable_content">
      ...
      <main class="flex-1 min-w-0 w-full" role="content">
       @if (request()->routeIs('settings.*'))
        @include('settings.partials.settings-spacing')
       @endif
       @unless (request()->routeIs('dashboard'))
        <div class="fin-pulse-page min-w-0 w-full max-w-full overflow-x-hidden">
       @endunless
       @yield('content')
       @unless (request()->routeIs('dashboard'))
        </div>
         ...
         <div class="kt-menu kt-menu-default px-0.5 flex-col">
           ...
           <div class="kt-menu-link flex items-center jistify-between gap-2">
            <div class="flex items-center grow gap-2">
             <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
              <img alt="" class="size-6 shrink-0" src="{{ asset('metronic/assets/media/brand-logos/jira.svg') }}"/>
             </div>
             <div class="flex flex-col gap-0.5">
          ...
          <div class="kt-menu-item">
           <div class="kt-menu-link flex items-center jistify-between gap-2">
            <div class="flex items-center grow gap-2">
             <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
              <img alt="" class="size-6 shrink-0" src="{{ asset('metronic/assets/media/brand-logos/inferno.svg') }}"/>
             </div>
             <div class="flex flex-col gap-0.5">
              <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
               Inferno
            ...
            <div class="flex justify-end shrink-0">
             <div class="flex -space-x-2">
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-14.png') }}"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-12.png') }}"/>
              </div>
              <div class="flex">
               <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-9.png') }}"/>
              </div>
             </div>
            </div>
           </div>
          ...
          <div class="grid gap-1">
           <div class="kt-menu-item">
            <div class="kt-menu-link flex justify-between gap-2">
             <div class="flex items-center gap-2.5">
              <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('metronic/assets/media/avatars/300-3.png') }}"/>
              <div class="flex flex-col">
           ...
           <div class="kt-menu-item">
            <div class="kt-menu-link flex justify-between gap-2">
             <div class="flex items-center gap-2.5">
              <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('metronic/assets/media/avatars/300-1.png') }}"/>
              <div class="flex flex-col">
               <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
                Esther Howard
               </a>
       ...
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        ...
        <div class="kt-menu-item">
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          <div class="flex items-center grow gap-2">
           <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{ asset('metronic/assets/media/brand-logos/evernote.svg') }}"/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Evernote
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-6.png') }}"/>
            </div>
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-3.png') }}"/>
            </div>
            ...
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-8.png') }}"/>
            </div>
           </div>
          </div>
         </div>
        ...
        <div class="kt-menu-item">
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          <div class="flex items-center grow gap-2">
           <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{ asset('metronic/assets/media/brand-logos/gitlab.svg') }}"/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Gitlab
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-18.png') }}"/>
            </div>
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-17.png') }}"/>
            </div>
           </div>
          </div>
         </div>
        ...
        <div class="kt-menu-item">
         <div class="kt-menu-link flex items-center jistify-between gap-2">
          <div class="flex items-center grow gap-2">
           <div class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
            <img alt="" class="size-6 shrink-0" src="{{ asset('metronic/assets/media/brand-logos/google-webdev.svg') }}"/>
           </div>
           <div class="flex flex-col gap-0.5">
            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
             Google webdev
          ...
          <div class="flex justify-end shrink-0">
           <div class="flex -space-x-2">
            ...
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-20.png') }}"/>
            </div>
            <div class="flex">
             <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6" src="{{ asset('metronic/assets/media/avatars/300-21.png') }}"/>
            </div>
           </div>
          </div>
         </div>
       ...
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        <div class="grid gap-1">
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('metronic/assets/media/avatars/300-11.png') }}"/>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
              Jacob Jones
             </a>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('metronic/assets/media/avatars/300-5.png') }}"/>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
              TLeslie Alexander
             </a>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex justify-between gap-2">
           <div class="flex items-center gap-2.5">
            <img alt="" class="rounded-full size-9 shrink-0" src="{{ asset('metronic/assets/media/avatars/300-2.png') }}"/>
            <div class="flex flex-col">
             <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
              Cody Fisher
             </a>
       ...
       <div class="kt-menu kt-menu-default px-0.5 flex-col">
        <div class="grid">
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('metronic/assets/media/file-types/pdf.svg') }}"/>
            <div class="flex flex-col">
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('metronic/assets/media/file-types/doc.svg') }}"/>
            <div class="flex flex-col">
             <span class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
              Report-v1.docx
             </span>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('metronic/assets/media/file-types/javascript.svg') }}"/>
            <div class="flex flex-col">
             <span class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
              Framework-App.js
             </span>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('metronic/assets/media/file-types/ai.svg') }}"/>
            <div class="flex flex-col">
             <span class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
              Framework-App.js
             </span>
         ...
         <div class="kt-menu-item">
          <div class="kt-menu-link flex items-center">
           <div class="flex items-center grow gap-2.5">
            <img src="{{ asset('metronic/assets/media/file-types/php.svg') }}"/>
            <div class="flex flex-col">
             <span class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
              appController.js
             </span>
      ...
      <div class="hidden" id="search_modal_empty">
       <div class="flex flex-col text-center py-9 gap-5">
        <div class="flex justify-center">
         <img alt="image" class="dark:hidden max-h-[113px]" src="{{ asset('metronic/assets/media/illustrations/33.svg') }}"/>
         <img alt="image" class="light:hidden max-h-[113px]" src="{{ asset('metronic/assets/media/illustrations/33-dark.svg') }}"/>
        </div>
        <div class="flex flex-col gap-1.5">
     ...
     <div class="p-5">
      <div class="grid place-items-center gap-1">
       <div class="flex justify-center items-center rounded-full">
         <img class="rounded-full max-h-[55px] max-w-full" src="{{ asset('metronic/assets/media/avatars/300-1.png') }}"/>
       </div>
  ...
  <script src="{{ asset('metronic/assets/js/widgets/general.js') }}"></script>
  {{-- Metronic Welcome Message 2 uses canvas-confetti for celebration effects --}}
  <script src="{{ asset('metronic/assets/vendors/canvas-confetti/canvas-confetti.min.js') }}"></script>

  {{-- Pulse UI Kit profile avatar (Lottie) --}}
  <script src="{{ route('pulse-ui-kit.asset', ['file' => 'min.js']) }}"></script>
  <script src="{{ route('pulse-ui-kit.asset', ['file' => 'profile-lottie-data.js']) }}"></script>
  <script src="{{ route('pulse-ui-kit.asset', ['file' => 'profile.js']) }}"></script>
  <script>
    (function () {
      var root = document.getElementById('topbar_user_menu');
      var lottieEl = document.getElementById('lottie-profile-avatar');
      if (!root || !lottieEl) return;
      if (window.PulseProfile && typeof window.PulseProfile.init === 'function') {
        window.PulseProfile.init({ rootElement: root, lottieContainerElement: lottieEl });
      }
    })();
  </script>
