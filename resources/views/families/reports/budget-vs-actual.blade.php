...
<div class="kt-container-fixed px-4 sm:px-6 lg:px-8 py-6 lg:py-8 pb-12">
                ...
                <div class="kt-card rounded-xl border border-border shadow-sm overflow-hidden bg-card" style="padding: 1.25rem 1.5rem;">
                    <div class="flex items-center justify-between gap-3 mb-2">
                        <div>
                            ...
                            <a href="{{ route('families.wallets.show', $primaryWallet) }}" class="text-sm font-semibold text-primary hover:underline">
                                {{ $primaryWallet->name }}
                            </a>
                        </div>
    ...
    <div class="kt-card rounded-xl border border-border shadow-sm overflow-hidden bg-card mb-6">
        ...
        <div class="kt-card-content pt-4">
            <form method="get" action="{{ route('families.reports.budget-vs-actual') }}" class="flex flex-wrap items-end gap-4">
                <div>
                ...
                <a href="{{ route('families.reports.budget-vs-actual') }}" class="kt-btn kt-btn-ghost">Reset</a>
            </form>
        </div>
    </div>
