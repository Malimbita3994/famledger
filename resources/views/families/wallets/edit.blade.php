        ...
        <div class="grid gap-5 lg:gap-7.5 w-full max-w-5xl mx-auto">
            <div class="kt-card pb-2.5">
                ...
                <div class="kt-card-content grid gap-5">
                    ...
                    {{-- Metronic styles.css omits grid-cols-*; use famledger-form-grids.css (same as create) --}}
                    <div class="famledger-form-row-3">
                        <div class="famledger-form-field flex flex-col gap-2">
                            <label for="name" class="kt-form-label">Wallet name <span class="text-destructive">*</span></label>
                            <input type="text" name="name" id="name" value="{{ old('name', $wallet->name) }}" required placeholder="e.g. Home Cash, Emergency Fund" class="kt-input w-full" aria-invalid="{{ $errors->has('name') ? 'true' : 'false' }}" />
                        ...
                        <div class="famledger-form-field flex flex-col gap-2">
                            ...
                            <select name="type" id="type" required class="kt-select w-full" aria-invalid="{{ $errors->has('type') ? 'true' : 'false' }}">
                        ...
                        <div class="famledger-form-field flex flex-col gap-2">
                            ...
                            <select name="currency_code" id="currency_code" required class="kt-select w-full" aria-invalid="{{ $errors->has('currency_code') ? 'true' : 'false' }}">
                    ...
                    <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                        ...
                        <div class="grow">
                            <textarea name="description" id="description" rows="3" placeholder="Short description" class="kt-textarea resize-y" aria-invalid="{{ $errors->has('description') ? 'true' : 'false' }}">{{ old('description', $wallet->description) }}</textarea>
                    ...
                    <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                        ...
                        <div class="grow">
                            <input type="number" name="initial_balance" id="initial_balance" value="{{ old('initial_balance', $wallet->initial_balance) }}" step="0.01" min="0" placeholder="0" class="kt-input" />
                    ...
                    <div class="flex justify-end pt-2 gap-2">
                        <a href="{{ route('families.wallets.index') }}" class="kt-btn kt-btn-outline">Cancel</a>
                        <a href="{{ route('families.wallets.show', $wallet) }}" class="kt-btn kt-btn-ghost">View wallet</a>
