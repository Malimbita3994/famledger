...
<div class="kt-container-fixed px-4 sm:px-6 lg:px-8 py-6 lg:py-8 pb-12">
    ...
    <form action="{{ route('families.wallets.store') }}" method="POST">
        @csrf
                ...
                <div class="kt-card-content grid gap-5">
                    ...
                    <div class="famledger-form-row-3">
                        <div class="famledger-form-field flex flex-col gap-2">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="e.g. Home Cash, Emergency Fund" class="kt-input w-full" aria-invalid="{{ $errors->has('name') ? 'true' : 'false' }}" />
