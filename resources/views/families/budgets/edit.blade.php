...
<div class="kt-container-fixed px-4 sm:px-6 lg:px-8 py-6 lg:py-8 pb-12">
    ...
    <a href="{{ route('families.budgets.show', $budget) }}" class="inline-flex items-center text-sm text-muted-foreground hover:text-foreground transition-colors mb-6">
        <i class="ki-filled ki-left text-base mr-1"></i>
        Back to budget
    </a>

    <form action="{{ route('families.budgets.update', $budget) }}" method="POST" id="budget-form">
        @csrf
        @method('PUT')
            ...
            <div class="kt-card pb-2.5">
                ...
                <div class="kt-card-content grid gap-5">
                        ...
                        <div id="scope-project" class="budget-main-col" style="display: none;">
                            ...
                            <select name="project_id" id="project_id" class="kt-select">
                                ...
                                @foreach ($projects as $proj)
                                    <option value="{{ $proj->id }}" @selected((string) old('project_id', $budget->project_id) === (string) $proj->id)>{{ $proj->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="flex justify-end pt-2 gap-2">
                        <a href="{{ route('families.budgets.show', $budget) }}" class="kt-btn kt-btn-outline">Cancel</a>
